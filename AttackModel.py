...
def runAttacks(models_list):
    ...
    for model in models_list:
        ...
        probs_adv_pgd, junk, X_adv = wbAttack(model, ProjectedGradientDescent, att_params, model.X_valid, model.Y_valid)
        print("")
        
        print("Running CW attack:")
        att_params = {'clip_min': model.minval, 'clip_max':model.maxval,  'binary_search_steps':10, 'learning_rate':1e-3}
        probs_adv_cw, junk, X_adv = wbAttack(model, CarliniWagnerL2, att_params, model.X_valid[0:100], model.Y_valid[0:100])
        print("")
        
        print("Running Blind Spot attack, alpha=0.8:")
        att_params = {'clip_min': model.minval, 'clip_max':model.maxval,  'binary_search_steps':10, 'learning_rate':1e-3}
        probs_adv_bsa, junk, X_adv = wbAttack(model, CarliniWagnerL2, att_params, 0.8*model.X_valid[0:100], model.Y_valid[0:100])
        print("")
    ...
    return probs_benign, probs_adv_pgd, probs_adv_cw, probs_adv_bsa, probs_random, probs_noise
        

models_list = [m4]
probs_benign, probs_adv_pgd, probs_adv_cw, probs_adv_bsa, probs_random, probs_noise = runAttacks(models_list)


np.save('plots/CIFAR/tanh_32_diverse_CIFAR/tanh_32_diverse_probs_benign.npy', probs_benign)
np.save('plots/CIFAR/tanh_32_diverse_CIFAR/tanh_32_diverse_probs_adv_pgd.npy', probs_adv_pgd)
np.save('plots/CIFAR/tanh_32_diverse_CIFAR/tanh_32_diverse_probs_adv_cw.npy', probs_adv_cw)
np.save('plots/CIFAR/tanh_32_diverse_CIFAR/tanh_32_diverse_adv_bsa.npy', probs_adv_bsa)
np.save('plots/CIFAR/tanh_32_diverse_CIFAR/tanh_32_diverse_probs_random.npy', probs_random)
np.save('plots/CIFAR/tanh_32_diverse_CIFAR/tanh_32_diverse_probs_noise.npy', probs_noise)
